...
//namespace fabric {
var PasswordConsts;
(function (PasswordConsts) {
    (function (Type) {
        Type[Type["Placeholder"] = 0] = "Placeholder";
        Type[Type["Underlined"] = 1] = "Underlined";
    })(PasswordConsts.Type || (PasswordConsts.Type = {}));
    var Type = PasswordConsts.Type;
})(PasswordConsts || (PasswordConsts = {}));
/**
...
var PasswordField = (function () {
    ...
    PasswordField.prototype._setTextFieldType = function () {
    ...
    PasswordField.prototype._addListeners = function () {
        var _this = this;
