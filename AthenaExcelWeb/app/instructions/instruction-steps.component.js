...
var InstructionStepsComponent = (function () {
    function InstructionStepsComponent(router) {
        this.router = router;
        this.title = "WELCOME";
        this.addin_description = "The Athena Online Excel plugin helps you to extract data, manipulate data and import data from your online environment.";
        this.steps_intro = "Just take these steps:";
        this.steps = [{ step_number: 1, content: "Select the data you wish to aquire from Athena-Online, with the aquire option." },
